...
var Comb = function(predefinedOptions) {
    ...
    var supportedSyntaxes = Array.prototype.slice(arguments, 1);
     ...
     * Processes a string.
     *
     * @param {{string: String, syntax: String, filename: String, context: String}} options
     * @returns {String} Processed string
     */
    this.processString = function processString(options) {
        var text = options.string;
